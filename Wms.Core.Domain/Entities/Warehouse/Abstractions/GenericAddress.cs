using ErrorOr;
using Wms.Core.Domain.Entities.Warehouse.Abstractions.Validations;

namespace Wms.Core.Domain.Entities.Warehouse.Abstractions;

public abstract record GenericAddress
{
