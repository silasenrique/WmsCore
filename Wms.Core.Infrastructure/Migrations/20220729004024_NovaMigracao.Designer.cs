...
namespace Wms.Core.Infrastructure.Migrations
{
    ...
    [Migration("20220729004024_NovaMigracao")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Warehouse.Stock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Warehouse.StockAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Warehouse.Unitizer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Warehouse.UnitizerType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Warehouse.Zone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("AdressFormat")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Product.ProductControl", b =>
                {
                    b.HasOne("Wms.Core.Domain.Entities.Entity.DistributionCenter", null)
                        .WithMany()
                        .HasForeignKey("Cd")
                        .HasPrincipalKey("Code");
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Product.ProductPackaging", b =>
                {
                    ...
                    b.HasOne("Wms.Core.Domain.Entities.Warehouse.UnitizerType", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Warehouse.Stock", b =>
                {
                    ...
                    b.HasOne("Wms.Core.Domain.Entities.Warehouse.Unitizer", null)
                        .WithMany()
                    ...
                    b.HasOne("Wms.Core.Domain.Entities.Warehouse.StockAddress", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wms.Core.Domain.Entities.Warehouse.StockAddress", b =>
                {
                    ...
                    b.HasOne("Wms.Core.Domain.Entities.Warehouse.Zone", null)
                        .WithMany()
